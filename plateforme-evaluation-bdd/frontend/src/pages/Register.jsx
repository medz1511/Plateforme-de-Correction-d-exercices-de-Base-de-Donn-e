...
const RegisterPage = () => {
  ...
  return (
    <div className="flex h-screen bg-gray-900 text-white">
      ...
      {/* Main content - largeur optimisée */}
            ...
            <div className="bg-gray-800 p-5 rounded-lg shadow-lg">
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    name="fullName"
                    type="text"
                    className="bg-gray-700 appearance-none rounded w-full py-2 px-3 text-white text-sm leading-tight focus:outline-none focus:ring-2 focus:ring-indigo-500"
                ...
                <div className="flex items-center">
                  ...
                  <label htmlFor="terms" className="ml-2 block text-xs text-gray-300">
                    J'accepte les <a href="#" className="text-indigo-400">termes</a>
                  </label>
                </div>
              ...
              <div className="mt-4">
                ...
                <div className="mt-4 grid grid-cols-3 gap-2">
                  <button className="flex justify-center py-2 px-2 border border-gray-700 rounded-md bg-gray-700 hover:bg-gray-600">
