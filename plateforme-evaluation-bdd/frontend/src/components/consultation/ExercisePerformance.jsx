    ...
    return (
        ...
        >
            <div className="px-6 py-4 border-b border-gray-700">
                <h2 className="text-xl font-semibold text-white">Performance des exercices</h2>
            </div>
                    ...
                    <ResponsiveContainer width="100%" height="100%">
                        ...
                        >
                            ...
                            <Tooltip
                                ...
                                itemStyle={{ color: '#fff' }}
                            />
                            <Bar name="Note IA" dataKey="aiAvg" fill="#6366F1" barSize={20} />
                            <Bar name="Note professeur" dataKey="profAvg" fill="#10B981" barSize={20} />
                        </BarChart>
                    </ResponsiveContainer>
                )}
            </div>
